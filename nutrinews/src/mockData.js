...
const mockArticles = [
    {
        ...
        hashtags: ["#saudemental", "#nutrigenômica", "#bemestar", "#micronutrientes"],
        multimedia: [{ url: alimentosCerebro, caption: "Alimentos para o Cérebro" }],
    ...
    },
    {
        ...
        short_url: "https://www.instagram.com/gyovanna__bs/",
        hashtags: ["#probióticos", "#saudegastrointestinal", "#imunidade", "#saudecardiovascular"],
        multimedia: [{ url: probioticos, caption: "Iogurte com Probióticos" }],
    ...
    },
    {
        ...
        short_url: "https://www.instagram.com/gyovanna__bs/",
        hashtags: ["#alimentacaofuncional", "#dietaplantas", "#longevidade", "#antioxidantes"],
        multimedia: [{ url: vegetaisFrescos, caption: "Vegetais Frescos" }],
...

    {
        ...
        short_url: "https://www.instagram.com/gyovanna__bs/",
        hashtags: ["#hidratacao", "#saudegastrointestinal", "#saude", "#micronutrientes"],
        multimedia: [{ url: copoAgua, caption: "Copo de Água" }],
    ...
    },
    {
        ...
        short_url: "https://www.instagram.com/gyovanna__bs/",
        hashtags: ["#smoothie", "#proteína", "#fitonutrientes", "#energia"],
        multimedia: [{ url: smoothieVerde, caption: "Smoothie Verde" }],
    ...
    },
    {
        ...
        short_url: "https://www.instagram.com/gyovanna__bs/",
        hashtags: ["#fibras", "#saudegastrointestinal", "#nutrigenômica", "#perdadepeso"],
        multimedia: [{ url: fibras, caption: "Alimentos Ricos em Fibras" }],
    ...
    },
    {
        ...
        subsection: "Vegan",
        short_url: "https://www.instagram.com/gyovanna__bs/",
        hashtags: ["#vegan", "#alimentacaofuncional", "#proteína", "#hipertrofia"],
        multimedia: [{ url: jantarVegano, caption: "Jantar Vegano" }],
    ...
    },
    {
        ...
        subsection: "Sono",
        short_url: "https://www.instagram.com/gyovanna__bs/",
        hashtags: ["#sono", "#alimentacaosaudavel", "#bemestar", "#dicasdesono"],
        multimedia: [{ url: alimentosSono, caption: "Alimentos para Melhorar o Sono" }],
    ...
    },
    {
        ...
        short_url: "https://www.instagram.com/gyovanna__bs/",
        hashtags: ["#dietacetogenica", "#perdadepeso", "#saude", "#nutricao"],
        multimedia: [{ url: dietaCetogenica, caption: "Dieta Cetogênica" }],
